...
NEEDS ENGINE - Supports JSON output
...
```
cd existing_repo
git remote add origin https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:ebd84bea9599be6dfad6c1facd29ad57?https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint/-/settings/integrations)
