<!-- ⚠️ This README has been generated from the file(s) ".config/docs/blueprint-readme-codeclimate.md" ⚠️--><div align="center">
  <center>
    <a href="https://github.com/ProfessorManhattan/codeclimate-htmlhint">
      <img width="148" height="148" alt="HTMLHint logo" src="https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center"><i></i>HTMLHint CodeClimate Engine<i></i></h1></center>
...
<div align="center">
  ...
  <a href="https://github.com/ProfessorManhattan/codeclimate-htmlhint/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
    <img alt="Contributing" src="https://img.shields.io/badge/Contributing-Guide-0074D9?logo=github-sponsors&logoColor=white&style=for-the-badge" />
  </a>
  <a href="https://app.slack.com/client/T01ABCG4NK1/C01NN74H0LW/details/" title="Chat with us on Slack" target="_blank">
    <img alt="Slack" src="https://img.shields.io/badge/Slack-Chat-e01e5a?logo=slack&logoColor=white&style=for-the-badge" />
  </a>
  <a href="https://github.com/ProfessorManhattan/codeclimate-htmlhint" title="GitHub mirror" target="_blank">
    <img alt="GitHub" src="https://img.shields.io/badge/Mirror-GitHub-333333?logo=github&style=for-the-badge" />
  </a>
  <a href="https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint" title="GitLab repository" target="_blank">
    <img alt="GitLab" src="https://img.shields.io/badge/Repo-GitLab-fc6d26?logo=data:image/png;base64,&style=for-the-badge" />
  </a>
</div>
<br/>
<div align="center">
  <a title="Version: 2.9.2" href="https://github.com/ProfessorManhattan/codeclimate-htmlhint" target="_blank">
  ...
  <a title="GitLab build status" href="https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint/-/commits/master" target="_blank">
    <img alt="Build status" src="https://img.shields.io/gitlab/pipeline-status/megabyte-labs/docker/codeclimate/htmlhint?branch=master&label=build&logo=gitlab&logoColor=white&style=flat-square">
  </a>
  <a title="DockerHub image size" href="https://hub.docker.com/repository/docker/megabytelabs/htmlhint" target="_blank">
    <img alt="Image size" src="https://img.shields.io/docker/image-size/megabytelabs/htmlhint?logo=docker&sort=date&logoColor=white&style=flat-square">
  </a>
  <a title="DockerHub pulls" href="https://hub.docker.com/repository/docker/megabytelabs/htmlhint" target="_blank">
    <img alt="Pulls" src="https://img.shields.io/docker/pulls/megabytelabs/htmlhint?logo=docker&logoColor=white&style=flat-square">
  </a>
  <a title="DockerHub stars" href="https://hub.docker.com/repository/docker/megabytelabs/htmlhint" target="_blank">
    <img alt="Stars" src="https://img.shields.io/docker/stars/megabytelabs/htmlhint?logo=docker&logoColor=white&style=flat-square">
  </a>
  <a title="Documentation" href="https://megabyte.space/docs/docker" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg?logo=readthedocs&logoColor=white&style=flat-square" />
  </a>
  <a title="License: MIT" href="https://github.com/ProfessorManhattan/codeclimate-htmlhint/blob/master/LICENSE" target="_blank">
    <img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-yellow.svg?logo=data:image/png;base64,&style=flat-square" />
  </a>
</div>

> </br><h4 align="center">**A slim HTMLHint linter / CodeClimate engine for GitLab CI**</h4></br>
...
This project is the home of a **[HTMLHint](https://htmlhint.com/)** [CodeClimate](https://codeclimate.com/) engine. It was built to integrate HTMLHint results into the GitLab merge request web UI. This project also builds a slim, standalone HTMLHint linter which can be used in conjunction with the CodeClimate engine or in places where CodeClimate engine results are not required.

### Standalone

If you are interested in using the tool and have no need for CodeClimate integration, you can get the `latest`, `slim`, and versioned images without CodeClimate-related code by removing the `codeclimate-` string from the image name. For example, if the image is named `megabytelabs/codeclimate-htmlhint`, then you can get the same image without CodeClimate-related code by using the `megabytelabs/htmlhint` image. For a full listing of images to choose from, check out the [DockerHub page for this project](https://hub.docker.com/r/megabytelabs/htmlhint).

_Note:_ The DockerHub page for the CodeClimate engine version of this project is located on the aforementioned DockerHub page and also on a [separate DockerHub page](https://hub.docker.com/r/megabytelabs/codeclimate-htmlhint) prefixed with `codeclimate-`.
...
```shell
docker run -it -v ${PWD}:/work -w /work --rm megabytelabs/htmlhint:latest --help
```

This allows you to run HTMLHint without installing it locally. It also removes the image from your system when you are done. This could be good for security since the application is within a container and also keeps your file system clean.

You can also add a bash alias to your `~/.bashrc` file so that you can run the HTMLHint command at any time. To do this, add the following snippet to your `~/.profile` file (or equivalent):

```shell
htmlhint() {
    docker run -it -v ${PWD}:/work -w /work --rm megabytelabs/htmlhint:latest "$@"
}
```
...
```shell
docker pull megabytelabs/codeclimate-htmlhint:latest
docker tag megabytelabs/codeclimate-htmlhint:latest codeclimate/codeclimate-htmlhint:latest
```
...
docker build --pull -t "$DOCKERHUB_USERNAME/htmlhint:latest" .
docker push "$DOCKERHUB_USERNAME/htmlhint:latest"
```
...
export DOCKERHUB_PASSWORD=Your_DockerHub_Password_Here
docker login -u "$DOCKERHUB_USERNAME" -p "$DOCKERHUB_PASSWORD" docker.io
docker build -t "$DOCKERHUB_USERNAME/htmlhint:latest" .
docker-slim build --tag $DOCKERHUB_USERNAME/htmlhint:slim {{#if (eq (typeOf dockerSlimCommand) "string")}}dockerSlimCommand}}{{/if{{#if (not (eq (typeOf dockerSlimCommand) "string"))}}dockerSlimCommand[slug]}}{{/if $DOCKERHUB_USERNAME/htmlhint:latest
docker push "$DOCKERHUB_USERNAME/htmlhint:slim"
```
...
If you come up with an improvement, please do [open a pull request](repository.group.dockerCodeClimate/htmlhint/-/issues/new). And again, make sure you replace `DOCKERHUB_USERNAME` and `DOCKERHUB_PASSWORD` in the snippet above with your Docker Hub username and password. The commands in the snippet above will build the slim Docker image and upload it to [Docker Hub](https://hub.docker.com/) where it will be publicly accessible.
...
For more details, check out the [CONTRIBUTING.md](https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint/-/blob/master/CONTRIBUTING.md) file.
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/ProfessorManhattan/codeclimate-htmlhint/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/ProfessorManhattan/codeclimate-htmlhint/blob/master/docs/CONTRIBUTING.md).
...
Copyright © 2020-2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/docker/codeclimate/htmlhint/-/blob/master/LICENSE) licensed.
